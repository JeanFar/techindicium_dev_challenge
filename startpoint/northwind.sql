...
--
-- Implemented auto-populated primary key
...
CREATE TABLE customer_demographics (
    customer_type_id bpchar PRIMARY KEY NOT NULL,
    customer_desc text
);
...
CREATE TABLE orders (
    ...
    ship_name character varying(40) NOT NULL,
    ship_address character varying(60) NOT NULL,
    ship_city character varying(15) NOT NULL,
    ship_region character varying(15) NOT NULL,
    ship_postal_code character varying(10) NOT NULL,
    ship_country character varying(15) NOT NULL
);
...
CREATE TABLE products (
    ...
    category_id smallint NOT NULL,
    quantity_per_unit character varying(20) NOT NULL,
...
CREATE TABLE territories (
    territory_id character varying(20) PRIMARY KEY NOT NULL,
...
ALTER TABLE ONLY orders
 ADD CONSTRAINT fk_orders_shippers FOREIGN KEY (ship_via) REFERENCES shippers(ship_id);
